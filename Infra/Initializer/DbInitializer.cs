    ...
    public static class DbInitializer
    {
        ...
        public static void InitializeShiftAssignment(ApplicationDbContext dataBase, bool newDb)
        {
            ...
            new ShiftAssignmentData()
            {
                ...
                locationId = "locationId1",
                startTime = DateTime.Parse("2021-12-28T07:00:00"),
                endTime = DateTime.Parse("2021-12-28T13:00:00"),
            },
            new ShiftAssignmentData()
            {
                ...
                contractId = "contractId1",
                locationId = "locationId2",
                startTime = DateTime.Parse("2021-12-29T09:00:00"),
                endTime = DateTime.Parse("2021-12-29T17:00:00"),
            },
            new ShiftAssignmentData()
            {
